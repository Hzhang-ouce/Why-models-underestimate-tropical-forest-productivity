...
rpmodel <- function(
  ...
  if (do_ftemp_kphio) {
    ...
    # kphio <- (0.352+0.021*tc-tc^2 * 3.4/10^4)/8  # this is from Peng et al New phytologist 2020, we rewrite the kphio in the above equation
  ...
  out <- list(
    ...
    kphio = kphio,
    iabs = iabs,
    fact_jmaxlim= fact_jmaxlim,
    mprime = out_lue_vcmax$mprime
